# Form implementation generated from reading ui file '.\templates\ventana_salir.ui'
#
...
class Ui_dlgSalir(object):
    def setupUi(self, dlgSalir):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\templates\\../../.designer/backup/IMG/travel_car_BMV_1741.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap(".\\templates\\../IMG/imagen_salir.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.gridLayoutWidget = QtWidgets.QWidget(parent=dlgSalir)
