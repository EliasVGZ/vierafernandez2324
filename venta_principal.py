...
class Ui_VentanaPrincipal(object):
    def setupUi(self, VentanaPrincipal):
        ...
        VentanaPrincipal.resize(1107, 889)
        ...
        self.widget.setGeometry(QtCore.QRect(14, 10, 1028, 194))
        ...
        self.lblProvincia = QtWidgets.QLabel(parent=self.widget)
        ...
        self.btnCalendario = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.cmbProvincia = QtWidgets.QComboBox(parent=self.widget)
        ...
        self.lblLocalidad = QtWidgets.QLabel(parent=self.widget)
        ...
        self.cmbLocalidad = QtWidgets.QComboBox(parent=self.widget)
...
"}")
        ...
        VentanaPrincipal.setTabOrder(self.txtDireccion, self.txtMovil)
        VentanaPrincipal.setTabOrder(self.txtMovil, self.txtSalario)
        VentanaPrincipal.setTabOrder(self.txtSalario, self.cmbProvincia)
        VentanaPrincipal.setTabOrder(self.cmbProvincia, self.cmbLocalidad)
        VentanaPrincipal.setTabOrder(self.cmbLocalidad, self.chkA)
        ...
        VentanaPrincipal.setTabOrder(self.chkD, self.rbtTodos)
        VentanaPrincipal.setTabOrder(self.rbtTodos, self.rbtAlta)
        VentanaPrincipal.setTabOrder(self.rbtAlta, self.rbtBaja)
        VentanaPrincipal.setTabOrder(self.rbtBaja, self.btnAltaDriver)
        VentanaPrincipal.setTabOrder(self.btnAltaDriver, self.btnBajaDriver)
        VentanaPrincipal.setTabOrder(self.btnBajaDriver, self.btnModifDriver)
        VentanaPrincipal.setTabOrder(self.btnModifDriver, self.tabDrivers)
