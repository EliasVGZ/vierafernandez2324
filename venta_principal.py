...
class Ui_VentanaPrincipal(object):
    def setupUi(self, VentanaPrincipal):
        ...
        VentanaPrincipal.resize(1075, 887)
...
"}")
        ...
        self.lbl_codig = QtWidgets.QLabel(parent=self.frame_2)
        self.lbl_codig.setGeometry(QtCore.QRect(230, 20, 55, 16))
        self.lbl_codig.setObjectName("lbl_codig")
        self.txtDni2 = QtWidgets.QLineEdit(parent=self.frame_2)
        self.txtDni2.setGeometry(QtCore.QRect(300, 20, 121, 22))
        ...
        self.lbl_codigo2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lbl_codigo2.setGeometry(QtCore.QRect(30, 20, 55, 16))
        self.lbl_codigo2.setObjectName("lbl_codigo2")
        self.lblCodCliente = QtWidgets.QLabel(parent=self.frame_2)
        self.lblCodCliente.setGeometry(QtCore.QRect(90, 10, 100, 30))
        ...
        self.txt_razonSocial = QtWidgets.QLineEdit(parent=self.frame_2)
        self.txt_razonSocial.setGeometry(QtCore.QRect(590, 20, 113, 20))
        self.txt_razonSocial.setObjectName("txt_razonSocial")
        self.label_razonSocial = QtWidgets.QLabel(parent=self.frame_2)
        self.label_razonSocial.setGeometry(QtCore.QRect(500, 20, 81, 16))
        self.label_razonSocial.setMinimumSize(QtCore.QSize(40, 0))
        self.label_razonSocial.setObjectName("label_razonSocial")
        self.lblDireccion_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblDireccion_2.setGeometry(QtCore.QRect(30, 60, 60, 24))
        ...
        self.txtDireccionCliente = QtWidgets.QLineEdit(parent=self.frame_2)
        self.txtDireccionCliente.setGeometry(QtCore.QRect(100, 60, 350, 20))
        ...
        self.lblProvincia_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblProvincia_2.setGeometry(QtCore.QRect(500, 60, 58, 25))
        ...
        self.cmbProvinciaCliente = QtWidgets.QComboBox(parent=self.frame_2)
        self.cmbProvinciaCliente.setGeometry(QtCore.QRect(570, 60, 140, 20))
        self.cmbProvinciaCliente.setMinimumSize(QtCore.QSize(140, 0))
        self.cmbProvinciaCliente.setObjectName("cmbProvinciaCliente")
        self.lblLocalidad_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblLocalidad_2.setGeometry(QtCore.QRect(720, 60, 59, 20))
        ...
        self.cmbLocalidadCliente = QtWidgets.QComboBox(parent=self.frame_2)
        self.cmbLocalidadCliente.setGeometry(QtCore.QRect(790, 60, 170, 20))
        ...
        self.lblMovil_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblMovil_2.setGeometry(QtCore.QRect(30, 110, 55, 23))
        ...
        self.txtTelefono = QtWidgets.QLineEdit(parent=self.frame_2)
        self.txtTelefono.setGeometry(QtCore.QRect(100, 110, 150, 20))
        ...
        self.btnAltaCliente.setGeometry(QtCore.QRect(280, 150, 75, 23))
        ...
        self.btnModifCliente.setGeometry(QtCore.QRect(420, 150, 75, 23))
        ...
        self.btnBajaCliente.setGeometry(QtCore.QRect(550, 150, 75, 23))
        self.btnBajaCliente.setMinimumSize(QtCore.QSize(75, 20))
        self.btnBajaCliente.setObjectName("btnBajaCliente")
        self.lblValidarDni_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblValidarDni_2.setGeometry(QtCore.QRect(430, 20, 20, 30))
        ...
        self.lblEstado_2 = QtWidgets.QLabel(parent=self.frame_2)
        self.lblEstado_2.setGeometry(QtCore.QRect(500, 100, 58, 20))
        ...
        self.rbtTodosCliente = QtWidgets.QRadioButton(parent=self.frame_2)
        self.rbtTodosCliente.setGeometry(QtCore.QRect(570, 100, 70, 17))
        ...
        self.rbtAltaCliente = QtWidgets.QRadioButton(parent=self.frame_2)
        self.rbtAltaCliente.setGeometry(QtCore.QRect(640, 100, 67, 17))
        ...
        self.rbtBajaCliente = QtWidgets.QRadioButton(parent=self.frame_2)
        self.rbtBajaCliente.setGeometry(QtCore.QRect(710, 100, 67, 17))
